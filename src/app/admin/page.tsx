            ...
            <CardContent>
              {leagues.length === 0 ? (
                ...
                <div className="flex flex-col divide-y">
                  <div className="-mx-2 grid grid-cols-[2fr_1.5fr_1fr_1.75rem] items-center gap-4 px-2 pb-2 text-xs font-medium text-muted-foreground">
                  ...
                  {leagues.map((league) => {
                    ...
                    return (
                      <div
                        key={league.id}
                        className="relative -mx-2 grid grid-cols-[2fr_1.5fr_1fr_1.75rem] items-center gap-4 px-2 py-3 transition-colors hover:bg-muted/50"
                      >
                        <Link
